...
class LicenseValidationService {
  ...
  Future<Map<String, dynamic>> checkBlockStatus() async {
    ...
    // Hitung durasi hukuman (Exponential)
    // 2 kali gagal -> 30 detik
    // 3 kali gagal -> 2 menit
    // 4 kali gagal -> 10 menit
    // 5 kali gagal -> 1 jam
  ...
  Future<void> submitSurvey({
    ...
    try {
      ...
      print('Error saat submit survey: $e');
      throw Exception('Gagal mengirim survey: $e');
    }
  }
}
