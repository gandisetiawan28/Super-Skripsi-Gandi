...
final googleSignInProvider = Provider<auth.GoogleSignIn>((ref) {
  final isAndroid = Platform.isAndroid;
  return auth.GoogleSignIn(
    params: auth.GoogleSignInParams(
      // Pada Android, jangan berikan clientId agar ia menggunakan native SHA-1 auto-detection
      clientId: isAndroid ? null : ApiConfig.googleClientId,
      clientSecret: isAndroid ? null : ApiConfig.googleClientSecret,
